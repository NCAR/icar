...
Documentation is (slowly) being build on [readthedocs](http://icar.readthedocs.org/en/stable/?badge=latest) and doxygen based documentation can be built now by hand, and is available through [github-pages](http://NCAR.github.io/icar) soon. 
