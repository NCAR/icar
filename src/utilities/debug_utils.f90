...
contains
    ...
    subroutine domain_check(domain, error_msg, fix)
        ...
        call check_var(domain%water_vapor%data_3d,           name="qv",      msg=error_msg, less_than    =0.0,   fix=fix_data)
        call check_var(domain%cloud_water_mass%data_3d,      name="cloud",   msg=error_msg, less_than    =0.0,   fix=fix_data)
        call check_var(domain%cloud_ice_mass%data_3d,        name="ice",     msg=error_msg, less_than    =0.0,   fix=fix_data)
        call check_var(domain%cloud_ice_number%data_3d,      name="nice",    msg=error_msg, less_than    =0.0,   fix=fix_data)
        call check_var(domain%snow_mass%data_3d,             name="qsnow",   msg=error_msg, less_than    =0.0,   fix=fix_data)
        call check_var(domain%snow_number%data_3d,           name="nsnow",   msg=error_msg, less_than    =0.0,   fix=fix_data)
        call check_var(domain%rain_mass%data_3d,             name="qrain",   msg=error_msg, less_than    =0.0,   fix=fix_data)
