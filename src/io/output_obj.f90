...
contains
    ...
    module subroutine add_variables(this, var_list, domain)
        ...
        if (0<var_list( kVARS%crop_category) )              call this%add_to_output( get_metadata( kVARS%crop_category                , domain%crop_category%data_2d))
        ...
        if (0<var_list( kVARS%irr_eventno_sprinkler) )      call this%add_to_output( get_metadata( kVARS%irr_eventno_sprinkler        , domain%irr_eventno_sprinkler%data_2d))
        if (0<var_list( kVARS%irr_eventno_micro) )          call this%add_to_output( get_metadata( kVARS%irr_eventno_micro            , domain%irr_eventno_micro%data_2d))
        if (0<var_list( kVARS%irr_eventno_flood) )          call this%add_to_output( get_metadata( kVARS%irr_eventno_flood            , domain%irr_eventno_flood%data_2d))
        ...
        if (0<var_list( kVARS%plant_growth_stage) )         call this%add_to_output( get_metadata( kVARS%plant_growth_stage           , domain%plant_growth_stage%data_2d))
        ...
        if (0<var_list( kVARS%snow_nlayers) )               call this%add_to_output( get_metadata( kVARS%snow_nlayers                 , domain%snow_nlayers%data_2d))
