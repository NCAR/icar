...
contains
    ...
    subroutine create_variables(this, opt)
        ...
        if (0<opt%vars_to_allocate( kVARS%crop_category) )              call setup(this%crop_category,            this%grid2d )
        ...
        if (0<opt%vars_to_allocate( kVARS%irr_eventno_sprinkler) )      call setup(this%irr_eventno_sprinkler,    this%grid2d )
        if (0<opt%vars_to_allocate( kVARS%irr_eventno_micro) )          call setup(this%irr_eventno_micro,        this%grid2d )
        if (0<opt%vars_to_allocate( kVARS%irr_eventno_flood) )          call setup(this%irr_eventno_flood,        this%grid2d )
        ...
        if (0<opt%vars_to_allocate( kVARS%plant_growth_stage) )         call setup(this%plant_growth_stage,       this%grid2d )
        ...
        if (0<opt%vars_to_allocate( kVARS%precip_in_total) )            call setup(this%precip_in_total,          this%grid2d )
        ...
        if (0<opt%vars_to_allocate( kVARS%cos_zenith) )                 call setup(this%cos_zenith,               this%grid2d)
